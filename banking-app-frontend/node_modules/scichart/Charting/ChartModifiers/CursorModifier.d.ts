...
import { ILineAnnotation } from "../Visuals/Annotations/LineAnnotation";
...
export interface ICursorModifierOptions extends IChartModifierBaseOptions {
     ...
     * Default `new Thickness(2, 4, 2, 4)` // 2px of x-padding and 4px of y-padding
     */
    ...
    /**
     * When true, the `CursorModifier` will draw the Line & Tooltips only using SVG, else they will be drawn natively.
     *
     * @default true
     */
    isSvgOnly?: boolean;
    /**
     * Controls which elements are shown on charts the mouse is not over, when using modifierGroup.  By default all are shown
     */
    showOnOthersInGroup?: {
        xLine?: boolean;
        yLine?: boolean;
...
export declare class CursorModifier extends ChartModifierBase2D implements ITooltipable {
    ...
    protected xLineAnnotation: ILineAnnotation | undefined;
    protected yLineAnnotation: ILineAnnotation | undefined;
    ...
    protected isSvgOnlyProperty: boolean;
    private isMasterEvent;
    /**
     ...
     */
    get isSvgOnly(): boolean;
    set isSvgOnly(value: boolean);
    /**
    ...
    protected newLineAnnotation(axisLabelFill: string, axisLabelStroke: string): ILineAnnotation;

...
var SvgLineAnnotation_1 = require("../Visuals/Annotations/SvgLineAnnotation");
/**
...
var CursorModifier = /** @class */ (function (_super) {
    ...
    function CursorModifier(options) {
         ...
         */
        _this.axisLabelPadding = undefined;
        /**
         * Gets or sets the axis label corner/border radius, in pixels
         */
        _this.axisLabelCornerRadius = 2;
        /**
        ...
        _this.showOnOthersInGroup = { xLine: true, yLine: true, tooltip: true };
        ...
        _this.axisLabelPadding = (_r = options === null || options === void 0 ? void 0 : options.axisLabelPadding) !== null && _r !== void 0 ? _r : _this.axisLabelPadding;
        _this.axisLabelCornerRadius = (_s = options === null || options === void 0 ? void 0 : options.axisLabelCornerRadius) !== null && _s !== void 0 ? _s : _this.axisLabelCornerRadius;
        _this.isSvgOnlyProperty = (_t = options === null || options === void 0 ? void 0 : options.isSvgOnly) !== null && _t !== void 0 ? _t : _this.isSvgOnlyProperty;
        _this.placementDivIdProperty = (_u = options === null || options === void 0 ? void 0 : options.placementDivId) !== null && _u !== void 0 ? _u : _this.placementDivIdProperty;
        _this.showOnOthersInGroup = (_v = options === null || options === void 0 ? void 0 : options.showOnOthersInGroup) !== null && _v !== void 0 ? _v : _this.showOnOthersInGroup;
        ...
        _this.tooltipLegendTemplate =
            (_w = options === null || options === void 0 ? void 0 : options.tooltipLegendTemplate) !== null && _w !== void 0 ? _w : _this.tooltipLegendTemplate;
        _this.tooltipLegendOffsetX = (_x = options === null || options === void 0 ? void 0 : options.tooltipLegendOffsetX) !== null && _x !== void 0 ? _x : _this.tooltipLegendOffsetX;
        _this.tooltipLegendOffsetY = (_y = options === null || options === void 0 ? void 0 : options.tooltipLegendOffsetY) !== null && _y !== void 0 ? _y : _this.tooltipLegendOffsetY;
        ...
        _this.tooltipDataTemplateProperty =
            (_z = options === null || options === void 0 ? void 0 : options.tooltipDataTemplate) !== null && _z !== void 0 ? _z : _this.tooltipDataTemplateProperty;
        _this.showXLine = (_0 = options === null || options === void 0 ? void 0 : options.showXLine) !== null && _0 !== void 0 ? _0 : _this.showXLine;
        _this.showYLine = (_1 = options === null || options === void 0 ? void 0 : options.showYLine) !== null && _1 !== void 0 ? _1 : _this.showYLine;
        _this.hitTestRadius = (_2 = options === null || options === void 0 ? void 0 : options.hitTestRadius) !== null && _2 !== void 0 ? _2 : _this.hitTestRadius;
        return _this;
    }
    /**
     * @inheritDoc
    ...
    CursorModifier.prototype.modifierMouseMove = function (args) {
        ...
        if (this.parentSurface.isSubSurface && !args.isActiveSubChartEvent)
            return;
        this.isMasterEvent = args.isMaster;
     ...
     * @inheritDoc
     */
    CursorModifier.prototype.onParentSurfaceLayoutComplete = function () {
        this.update();
    };
    ...
    Object.defineProperty(CursorModifier.prototype, "isSvgOnly", {
        /**
         * Gets or sets whether we should draw the Line & Tooltips only using SVG, else they will be drawn natively.
         */
        get: function () {
            return this.isSvgOnlyProperty;
        },
        set: function (value) {
            if (this.isSvgOnlyProperty !== value) {
                this.isSvgOnlyProperty = value;
                this.notifyPropertyChanged(constants_1.PROPERTY.IS_SVG_ONLY);
            }
        },
        enumerable: false,
        configurable: true
    ...
    CursorModifier.prototype.toJSON = function () {
        ...
        var options = {
            ...
            axisLabelCornerRadius: this.axisLabelCornerRadius,
            ...
            isSvgOnly: this.isSvgOnlyProperty,
            showOnOthersInGroup: this.showOnOthersInGroup
        };
    ...
    CursorModifier.prototype.update = function () {
        ...
        if (this.xLineAnnotation && (this.isMasterEvent || ((_b = (_a = this.showOnOthersInGroup) === null || _a === void 0 ? void 0 : _a.xLine) !== null && _b !== void 0 ? _b : true))) {
            this.xLineAnnotation.isHidden = false;
        }
        if (this.yLineAnnotation && (this.isMasterEvent || ((_d = (_c = this.showOnOthersInGroup) === null || _c === void 0 ? void 0 : _c.yLine) !== null && _d !== void 0 ? _d : true))) {
            this.yLineAnnotation.isHidden = false;
        }
        var showTooltip = this.showTooltip && (this.isMasterEvent || ((_f = (_e = this.showOnOthersInGroup) === null || _e === void 0 ? void 0 : _e.tooltip) !== null && _f !== void 0 ? _f : true));
        this.tooltipAnnotation.isHidden = false;
        this.tooltipAnnotation.showTooltip = showTooltip;
        if (translatedMousePoint) {
            ...
            if (showTooltip || this.tooltipLegendTemplate) {
                this.tooltipAnnotation.seriesInfos = this.getSeriesInfos();
            }
        }
    };
    CursorModifier.prototype.newLineAnnotation = function (axisLabelFill, axisLabelStroke) {
        var lineOptions = {
            ...
            xAxisId: this.xAxisId,
            yAxisId: this.yAxisId,
            labelPadding: this.axisLabelPadding,
            labelCornerRadius: this.axisLabelCornerRadius,
        };
        if (this.isSvgOnlyProperty) {
            return new SvgLineAnnotation_1.SvgLineAnnotation(lineOptions);
        }
        else {
            return new LineAnnotation_1.LineAnnotation(lineOptions);
        }
    };

...
var DataPointInfo = /** @class */ (function () {
    ...
    DataPointInfo.prototype.getValueByName = function (name) {
        var values = this.dataSeries.getYValuesByName(name);
        if (values) {
            return this.dataSeries.getNativeValue(values, this.index);
        }
        else
            return undefined;
    };

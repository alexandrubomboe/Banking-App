...
import { LineAnnotation, ILineAnnotation } from "../Visuals/Annotations/LineAnnotation";
import { RolloverLegendSvgAnnotation } from "../Visuals/Annotations/RolloverLegendSvgAnnotation";
import { SvgLineAnnotation } from "../Visuals/Annotations/SvgLineAnnotation";
...
export interface IRolloverModifierOptions extends IChartModifierBaseOptions {
    ...
    /**
     * When true, the `RolloverModifier` will draw the Line & Tooltips only using SVG, else they will be drawn natively.
     * @default true
     */
    isSvgOnly?: boolean;
    /**
...
export declare class RolloverModifier extends ChartModifierBase2D implements IRolloverModifier {
    ...
    readonly rolloverLineAnnotation: ILineAnnotation | undefined;
    ...
    protected createLine(options?: IRolloverModifierOptions): LineAnnotation | SvgLineAnnotation;
    /** @inheritDoc */

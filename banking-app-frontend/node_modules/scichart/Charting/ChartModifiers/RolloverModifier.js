...
exports.updateRolloverModifierProps = exports.splitIntoClusters = exports.calcTooltipPositions = exports.calcTooltipProps = exports.RolloverModifier = exports.TOOLTIP_SPACING = void 0;
...
var RolloverModifier = /** @class */ (function (_super) {
    ...
    function RolloverModifier(options) {
        ...
        _this.isSvgOnlyProperty = (_b = options === null || options === void 0 ? void 0 : options.isSvgOnly) !== null && _b !== void 0 ? _b : _this.isSvgOnlyProperty;
        _this.axisLabelPadding = (_c = options === null || options === void 0 ? void 0 : options.axisLabelPadding) !== null && _c !== void 0 ? _c : _this.axisLabelPadding;
        _this.axisLabelCornerRadius = (_d = options === null || options === void 0 ? void 0 : options.axisLabelCornerRadius) !== null && _d !== void 0 ? _d : _this.axisLabelCornerRadius;
        ...
        _this.tooltipLegendTemplate =
            (_e = options === null || options === void 0 ? void 0 : options.tooltipLegendTemplate) !== null && _e !== void 0 ? _e : _this.tooltipLegendTemplate;
        _this.tooltipLegendOffsetX = (_f = options === null || options === void 0 ? void 0 : options.tooltipLegendOffsetX) !== null && _f !== void 0 ? _f : _this.tooltipLegendOffsetX;
        _this.tooltipLegendOffsetY = (_g = options === null || options === void 0 ? void 0 : options.tooltipLegendOffsetY) !== null && _g !== void 0 ? _g : _this.tooltipLegendOffsetY;
        ...
        _this.tooltipDataTemplateProperty =
            (_h = options === null || options === void 0 ? void 0 : options.tooltipDataTemplate) !== null && _h !== void 0 ? _h : _this.tooltipDataTemplateProperty;
        _this.showRolloverLineProperty = (_j = options === null || options === void 0 ? void 0 : options.showRolloverLine) !== null && _j !== void 0 ? _j : _this.showRolloverLineProperty;
        _this.showTooltipProperty = (_k = options === null || options === void 0 ? void 0 : options.showTooltip) !== null && _k !== void 0 ? _k : _this.showTooltipProperty;
        ...
        _this.allowTooltipOverlappingProperty = (_l = options === null || options === void 0 ? void 0 : options.allowTooltipOverlapping) !== null && _l !== void 0 ? _l : _this.allowTooltipOverlappingProperty;
        _this.snapToDataPoint = (_m = options === null || options === void 0 ? void 0 : options.snapToDataPoint) !== null && _m !== void 0 ? _m : _this.snapToDataPoint;
        _this.hitTestRadius = (_o = options === null || options === void 0 ? void 0 : options.hitTestRadius) !== null && _o !== void 0 ? _o : _this.hitTestRadius;
        return _this;
    }
    RolloverModifier.prototype.createLine = function (options) {
        ...
        var lineOptions = {
            ...
            labelPadding: options === null || options === void 0 ? void 0 : options.axisLabelPadding,
            labelCornerRadius: options === null || options === void 0 ? void 0 : options.axisLabelCornerRadius,
            isHidden: true // to not show initially when mouse is out of canvas/subchart
        };
    ...
    RolloverModifier.prototype.onParentSurfaceLayoutComplete = function () {
        this.update();
    };
    /** @inheritDoc */
    ...
    RolloverModifier.prototype.getIncludedRenderableSeries = function () {
        ...
        var stackedSeries = this.parentSurface.renderableSeries.asArray().filter(function (rs) { return rs.isCollection; });
    ...
    RolloverModifier.prototype.toJSON = function () {
        ...
        var options = {
            ...
            axisLabelPadding: (_c = this.rolloverLineAnnotation) === null || _c === void 0 ? void 0 : _c.labelPadding,
            axisLabelCornerRadius: (_d = this.rolloverLineAnnotation) === null || _d === void 0 ? void 0 : _d.labelCornerRadius,
        };
    ...
    RolloverModifier.prototype.updateSeriesAnnotations = function () {
        ...
        rsList.forEach(function (rs, index) {
            ...
            if (hitTestInfo) {
                if (_this.hitTestRadius === 0 || hitTestInfo.isHit) {
...
var calcTooltipProps = function (index, rs, rolloverProps, seriesViewRect, xValue, yValue, absoluteXCoord, absoluteYCoord, hitTestInfo, pixelRatio, isY1, isVerticalChart) {
    ...
    var _a = rolloverProps.getTooltipSize(seriesInfo), width = _a.width, height = _a.height;
...
var calcTooltipPositions = function (tooltipArray, allowTooltipOverlapping, spacing, seriesViewRect, pixelRatio, isVerticalChart) {
    ...
    if (!allowTooltipOverlapping && length >= 2 && hasOverlap) {
        // Iterative cluster andr spreading until stable
        ...
        while (iteration < maxIterations) {
            ...
            if (clusters.length === previousClusterCount) {
                break; // most examples will only need 1 extra iter
            }
...
var splitIntoClusters = function (tooltipArray, spacing, pixelRatio, positionProperties) {
    ...
    for (var _i = 0, sorted_1 = sorted; _i < sorted_1.length; _i++) {
        ...
        if (currentCluster.length === 0) {
            ...
            if (currentStart <= lastEnd + spacing) {
                currentCluster.push(tooltip);
            }
            else {

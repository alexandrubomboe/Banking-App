...
var SeriesSelectionModifier = /** @class */ (function (_super) {
    ...
    SeriesSelectionModifier.prototype.updateSeriesSelected = function (arg) {
        ...
        if (arg.isSelected) {
            ...
            // Raise the selectionChanged event
            (_a = this.selectionChanged) === null || _a === void 0 ? void 0 : _a.raiseEvent(new SelectionChangedArgs_1.SelectionChangedArgs(this, this.selectedSeries, this.getIncludedRenderableSeries(), undefined));
        }
        else {
            ...
            (_b = this.selectionChanged) === null || _b === void 0 ? void 0 : _b.raiseEvent(new SelectionChangedArgs_1.SelectionChangedArgs(this, this.selectedSeries, this.getIncludedRenderableSeries(), undefined));
        }
    };
    SeriesSelectionModifier.prototype.updateSeriesHovered = function (arg) {
        ...
        if (arg.hovered) {
            ...
            // Raise the selectionChanged event
            (_a = this.hoverChanged) === null || _a === void 0 ? void 0 : _a.raiseEvent(new HoveredChangedArgs_1.HoveredChangedArgs(this, this.hoveredSeries, this.getIncludedRenderableSeries(), undefined));
        }
        else {
            this.hoveredSeries = (0, array_1.arrayRemove)(this.hoveredSeries, arg.sourceSeries);
            // Raise the selectionChanged event after series deselected
            (_b = this.hoverChanged) === null || _b === void 0 ? void 0 : _b.raiseEvent(new HoveredChangedArgs_1.HoveredChangedArgs(this, this.hoveredSeries, this.getIncludedRenderableSeries(), undefined));
        }
    };

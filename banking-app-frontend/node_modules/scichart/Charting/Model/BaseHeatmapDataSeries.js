...
var BaseHeatmapDataSeries = /** @class */ (function () {
    ...
    function BaseHeatmapDataSeries(webAssemblyContext, options) {
        ...
        this.cachedZRange = undefined;
        this.lastChangeCountForZRange = -1;
    ...
    Object.defineProperty(BaseHeatmapDataSeries.prototype, "zRange", {
         ...
         * @remarks
         * The zRange is memoized and only recalculated when data changes
         */
        get: function () {
            if (this.cachedZRange === undefined || this.lastChangeCountForZRange !== this.changeCountProperty) {
                this.cachedZRange = this.getZRange();
                this.lastChangeCountForZRange = this.changeCountProperty;
            }
            return this.cachedZRange;
        },
        enumerable: false,
        configurable: true
    });

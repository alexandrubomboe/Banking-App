...
var DoubleVectorProvider = /** @class */ (function () {
    ...
    DoubleVectorProvider.prototype.appendBuffer = function (wasmContext, destinationVector, jsArray) {
        (0, appendDoubleVectorFromJsArray_1.appendDoubleVectorFromBuffer)(wasmContext, destinationVector, jsArray);
    };
...
var FIFOVectorProvider = /** @class */ (function () {
    ...
    FIFOVectorProvider.prototype.appendBuffer = function (wasmContext, destinationVector, jsArray) {
        (0, appendDoubleVectorFromJsArray_1.appendDoubleVectorFromBuffer)(wasmContext, destinationVector, jsArray);
    };

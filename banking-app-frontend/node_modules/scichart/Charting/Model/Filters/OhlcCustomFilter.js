...
var OhlcCustomFilter = /** @class */ (function (_super) {
    ...
    OhlcCustomFilter.prototype.filter = function (startIndex, count) {
        ...
        var openValuesView = (0, vectorToArray_1.vectorToArrayViewF64)(this.getOriginalOpenValues(), this.webAssemblyContext);
        var highValuesView = (0, vectorToArray_1.vectorToArrayViewF64)(this.getOriginalHighValues(), this.webAssemblyContext);
        var lowValuesView = (0, vectorToArray_1.vectorToArrayViewF64)(this.getOriginalLowValues(), this.webAssemblyContext);
        var closeValuesView = (0, vectorToArray_1.vectorToArrayViewF64)(this.getOriginalYValues(), this.webAssemblyContext);
        var xValues = [];
        var openValues = [];
        var highValues = [];
        var lowValues = [];
        ...
        if (this.originalSeries.hasMetadata) {
            ...
            for (var i = startIndex; i < startIndex + count; i++) {
                xValues.push(xValuesView[i]);
                openValues.push(this.openfilterFunction(i, openValuesView[i]));
                highValues.push(this.highfilterFunction(i, highValuesView[i]));
                lowValues.push(this.lowfilterFunction(i, lowValuesView[i]));
                closeValues.push(this.closefilterFunction(i, closeValuesView[i]));

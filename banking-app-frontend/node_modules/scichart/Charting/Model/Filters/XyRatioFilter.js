...
var XyRatioFilter = /** @class */ (function (_super) {
    ...
    XyRatioFilter.prototype.toJSON = function (excludeData) {
        ...
        var divisorValuesView = (0, vectorToArray_1.vectorToArrayViewF64)(divisorRaw, this.webAssemblyContext);
        for (var i = 0; i < this.divisorSeries.count(); i++) {
            divisorValues.push(divisorValuesView[i]);
        }
    ...
    XyRatioFilter.prototype.filter = function (startIndex, count) {
        ...
        var divisorValuesView = (0, vectorToArray_1.vectorToArrayViewF64)(this.getDivisorYValues(), this.webAssemblyContext);
        // TODO check if metadata is needed here
        for (var i = startIndex; i < startIndex + count; i++) {
            xValues.push(xValuesView[i]);
            yValues.push(yValuesView[i] / divisorValuesView[i]);
        }

...
var XyyCustomFilter = /** @class */ (function (_super) {
    ...
    XyyCustomFilter.prototype.filter = function (startIndex, count) {
        ...
        var y1ValuesView = (0, vectorToArray_1.vectorToArrayViewF64)(this.getOriginalY1Values(), this.webAssemblyContext);
        ...
        if (this.originalSeries.hasMetadata) {
            ...
            for (var i = startIndex; i < startIndex + count; i++) {
                ...
                yValues.push(this.filterFunction(i, yValuesView[i]));
                y1Values.push(this.y1filterFunction(i, y1ValuesView[i]));

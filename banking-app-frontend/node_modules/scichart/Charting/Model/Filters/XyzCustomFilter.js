...
var XyzCustomFilter = /** @class */ (function (_super) {
    ...
    XyzCustomFilter.prototype.filter = function (startIndex, count) {
        ...
        var zValuesView = (0, vectorToArray_1.vectorToArrayViewF64)(this.getOriginalZValues(), this.webAssemblyContext);
        var xValues = [];
        var yValues = [];
        var zValues = [];
        ...
        if (this.originalSeries.hasMetadata) {
            ...
            for (var i = startIndex; i < startIndex + count; i++) {
                ...
                zValues.push(this.zfilterFunction(i, zValuesView[i]));

...
var DefaultPaletteProvider = /** @class */ (function () {
     ...
     * @inheritDoc
     */
    DefaultPaletteProvider.prototype.overrideFillArgb = function (xValue, yValue, index, opacity, metadata, otherValues) {
        return undefined;
    };
    /**
     * @inheritDoc
     */
    DefaultPaletteProvider.prototype.overrideStrokeArgb = function (xValue, yValue, index, opacity, metadata, otherValues) {
        return undefined;
    };
    /**
     * @inheritDoc
     */
    DefaultPaletteProvider.prototype.overridePointMarkerArgb = function (xValue, yValue, index, opacity, metadata, otherValues) {
        return undefined;
    };

...
export declare function getYyYRange(webAssemblyContext: TSciChart, indicesRange: NumberRange, yValues: SCRTDoubleVector, y1Values: SCRTDoubleVector, containsNaN: boolean): NumberRange;

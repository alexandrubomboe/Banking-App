...
export declare abstract class TickProvider {
     ...
     * @param coordCalc The current {@link CoordinateCalculatorBase}
     * @returns The array of major ticks, e.g. if we want to place gridlines at 100,120,140,160,180,200, then the
     * getMajorTicks() method should return an array with ```[100,120,140,160,180,200]```.
     */
    abstract getMajorTicks(minorDelta: number, majorDelta: number, visibleRange: NumberRange, coordCalc?: CoordinateCalculatorBase): number[];
    /**
     ...
     * getMinorTicks() method should return an array with ```[105, 110, 115]``` etc...
     */
    abstract getMinorTicks(minorDelta: number, majorDelta: number, visibleRange: NumberRange, coordCalc?: CoordinateCalculatorBase): number[];
}

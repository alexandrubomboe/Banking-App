...
var BoxAnnotation = /** @class */ (function (_super) {
    ...
    BoxAnnotation.prototype.drawWithProvider = function (renderContext, linesPen, fillBrush, xCalc, yCalc, rect, viewRect, clipRect) {
        ...
        var nativeContext = webGlRenderContext.getNativeContext();
        webGlRenderContext.setTranslationRotationAndClip(clipRect, viewRect.x, viewRect.y);
        args.SetNativeContext(nativeContext);
        args.SetXValues(this.xValues);
        args.SetYValues(this.yValues);
        args.SetXCoordinateCalculator(xCalc.nativeCalculator);
        args.SetYCoordinateCalculator(yCalc.nativeCalculator);

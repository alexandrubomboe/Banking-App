...
var CursorTooltipSvgAnnotation = /** @class */ (function (_super) {
    ...
    Object.defineProperty(CursorTooltipSvgAnnotation.prototype, "seriesInfos", {
        ...
        set: function (newSeriesInfos) {
            if (newSeriesInfos) {
                //const tooltipDataTemplate = this.cursorModifier.tooltipDataTemplate ?? defaultTooltipDataTemplate;
                var newsvgString = this.tooltipSvgTemplate(newSeriesInfos, this);
                // Only need to rerender if the displayed content changes.
                // This logic is needed to prevent infinite rerendering
                if (newsvgString !== this.svgString) {
    ...
    CursorTooltipSvgAnnotation.prototype.create = function (xCalc, yCalc, xCoordSvgTrans, yCoordSvgTrans) {
        ...
        var svgString = (_a = this.svgString) !== null && _a !== void 0 ? _a : this.tooltipSvgTemplate(this.seriesInfos, this);

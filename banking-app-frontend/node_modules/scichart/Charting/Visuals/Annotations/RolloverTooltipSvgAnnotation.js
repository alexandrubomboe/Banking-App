...
var rolloverTooltipSvgAnnotationHelpers_1 = require("./rolloverTooltipSvgAnnotationHelpers");
...
var defaultTooltipTemplate = function (id, seriesInfo, rolloverTooltip) {
    ...
    var tooltipDataTemplate = (_c = (_a = rolloverTooltip.tooltipProps.tooltipDataTemplate) !== null && _a !== void 0 ? _a : (_b = rolloverTooltip.tooltipProps.rolloverModifier) === null || _b === void 0 ? void 0 : _b.tooltipDataTemplate) !== null && _c !== void 0 ? _c : rolloverTooltipSvgAnnotationHelpers_1.defaultTooltipDataTemplate;
    // Reuse pre-computed lines if available, otherwise compute (backward compat for direct callers)
    var valuesWithLabels = ((_d = rolloverTooltip.tooltipLines) === null || _d === void 0 ? void 0 : _d.length) > 0
        ? rolloverTooltip.tooltipLines
        : tooltipDataTemplate(seriesInfo, tooltipTitle, tooltipLabelX, tooltipLabelY);
    // tooltip width — call method on props (overridable by users)
    var width = (_e = tooltipProps.width) !== null && _e !== void 0 ? _e : tooltipProps.calcTooltipWidth(valuesWithLabels.reduce(function (prev, cur) { return ((cur === null || cur === void 0 ? void 0 : cur.length) > prev ? cur.length : prev); }, 0));
    // tooltip height
    var height = (_f = tooltipProps.height) !== null && _f !== void 0 ? _f : tooltipProps.calcTooltipHeight(valuesWithLabels.length);

...
export declare abstract class AxisBase2D extends AxisCore implements IThemeable {
    ...
    /**
     * Gets or sets axis label area thickness, by default the value is calculated to have enough space for labels.
     * However, this property allows to set minimal width/height for vertical/horizontal axes.
     * Useful to align seriesViewRects for different charts
     */
    ...
    protected createAxisRender(useNativeText?: boolean): AxisRenderer;
    /**
     * Switches the {@link axisRenderer} to match the given useNativeText value.
     * Called when {@link LabelProviderBase2D.useNativeText} is changed at runtime.
     * @internal
     */

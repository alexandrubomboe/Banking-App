...
var DateTimeDeltaCalculator = /** @class */ (function (_super) {
    ...
    function DateTimeDeltaCalculator(webAssemblyContext, options) {
        ...
        _this.datePrecisionProperty = (_b = options === null || options === void 0 ? void 0 : options.datePrecision) !== null && _b !== void 0 ? _b : SmartDateLabelProvider_1.EDatePrecision.Seconds;
        _this.currIndex = Math.floor(_this.possibleDeltas.length / 2);
        return _this;
    }
    Object.defineProperty(DateTimeDeltaCalculator.prototype, "datePrecisionValue", {
        /**
    ...
    DateTimeDeltaCalculator.prototype.getDeltaFromRange = function (min, max, minorsPerMajor, maxTicks) {
        ...
        var calculateDelta = function (index) {
            var _a, _b;
            var deltaInSeconds = _this.possibleDeltasProperty[index];
            var deltaInTicks = deltaInSeconds * _this.datePrecisionProperty;
            tries++;
            if (tries > _this.possibleDeltas.length + 1) {
                performanceWarnings_1.performanceWarnings.dateTimeDeltaCalculatorBadDelta.warn();
                return deltaInTicks;
            }
            var ticksCount = Math.floor(diff / deltaInTicks);
            ...
            if (ticksCount > maxTicks && index < _this.possibleDeltasProperty.length - 1 && index !== _this.prevIndex) {
                ...
                var yearDelta = _super.prototype.getDeltaFromRange.call(_this, min / deltaInTicks, max / deltaInTicks, minorsPerMajor, maxTicks);
                return yearDelta.max * deltaInTicks;
            }
            else {

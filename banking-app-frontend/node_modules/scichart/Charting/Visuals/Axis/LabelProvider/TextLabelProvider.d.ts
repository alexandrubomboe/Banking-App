...
import { ILabel2DOptions, LabelInfo, LabelProviderBase2D } from "./LabelProviderBase2D";
...
export declare class TextLabelProvider extends LabelProviderBase2D {
    ...
    getLabelWidth(ctx: CanvasRenderingContext2D, labelText: string, labelStyle?: TTextStyle, labelInfo?: LabelInfo): number;

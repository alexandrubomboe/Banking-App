...
var getVertex = function (wasmContext, x, y, colour) {
    ...
    if (!vertex) {
        ...
        vertex.m_uiColor = colour !== null && colour !== void 0 ? colour : app_1.NEUTRAL_COLOR; // masked color
    }
    return vertex;
};
...
var getTextureVertex = function (wasmContext, x, y, colour, xTexCoord, yTexCoord) {
    ...
    if (!textureVertex) {
        ...
        textureVertex.m_uiColor = colour !== null && colour !== void 0 ? colour : app_1.NEUTRAL_COLOR; // masked color
    }

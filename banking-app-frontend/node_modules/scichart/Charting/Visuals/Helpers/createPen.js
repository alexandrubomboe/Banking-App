...
var createSCRTPen = function (wasmContext, htmlColorCode, strokeThickness, opacity, strokeDashArray, antiAliased) {
    ...
    var penDesc = new wasmContext.SCRTPenDescriptor();
    penDesc.m_uiColor = colorArgb;
    penDesc.m_fThickness = strokeThickness;
    penDesc.m_bAntiAliased = antiAliased;
    if (strokeDashArray && strokeDashArray.length) {
        ...
        penDesc.SetDashPattern(strokeDashFloatVector_1);
    }
    // Create a normal pen
    var pen = new wasmContext.SCRTPen(penDesc);
    penDesc.delete();
    return pen;
};

...
exports.getLabelValue = exports.getLineCoordinates = exports.getLabelCoordinates = exports.drawAxisMarkerAnnotation = exports.drawLineAnnotation = exports.drawModifiersAxisLabel = void 0;
var Rect_1 = require("../../../Core/Rect");
var AxisAlignment_1 = require("../../../types/AxisAlignment");
var LabelPlacement_1 = require("../../../types/LabelPlacement");
var drawModifiersAxisLabel = function (currentAxis, renderContext, labelCoord, fill, stroke, padding, cornerRadius) {
    if (!currentAxis.isVisible) {
        return undefined;
    }
    var formattedDataValue = (0, exports.getLabelValue)(currentAxis, labelCoord);
    var textStyle = __assign(__assign({}, currentAxis.dpiAdjustedLabelStyle), { color: stroke });
    return currentAxis.axisRenderer.drawModifiersAxisLabel(renderContext, formattedDataValue, labelCoord, currentAxis.axisAlignment, textStyle, fill, padding, cornerRadius);
};
...
var drawLineAnnotation = function (currentAxis, renderContext, labelPlacement, displayValue, x1Coord, x2Coord, y1Coord, y2Coord, textStyle, fill, strokePen, viewRect, showLabel, opacity, horizontalAlignment, verticalAlignment) {
    ...
    var text = displayValue || (0, exports.getLabelValue)(currentAxis, annotationCoord);
    ...
    var labelWidth = 0;
    var labelRect;
    var _a = (0, exports.getLineCoordinates)(x1Coord, y1Coord, x2Coord, y2Coord, labelHeight, labelWidth, labelPlacement, currentAxis), x1LineCoord = _a.x1LineCoord, y1LineCoord = _a.y1LineCoord, x2LineCoord = _a.x2LineCoord, y2LineCoord = _a.y2LineCoord;
    if (strokePen) {
...
var drawAxisMarkerAnnotation = function (currentAxis, renderContext, displayValue, markerCoordinate, x1Coord, y1Coord, textStyle, fill, opacity, image, imageWidth, imageHeight) {
    var nativeContext = renderContext.getNativeContext();
    var axisAlignment = currentAxis.axisAlignment;
    var text = displayValue || (0, exports.getLabelValue)(currentAxis, markerCoordinate);
    var _a = image
...
exports.getLineCoordinates = getLineCoordinates;

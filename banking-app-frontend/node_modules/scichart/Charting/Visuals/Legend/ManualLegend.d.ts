...
export interface IManualLegendOptions extends ILegendOptionsBase {
     ...
     * @param isChecked
     */
    isCheckedChangedCallback?: (item: TLegendItem, isChecked: boolean, legend?: ManualLegend) => void;
}
export declare class ManualLegend extends SciChartLegendBase {
    type: ELegendType;
    legendItemCheckedChangedCallback: (item: TLegendItem, isChecked: boolean, legend?: ManualLegend) => void;

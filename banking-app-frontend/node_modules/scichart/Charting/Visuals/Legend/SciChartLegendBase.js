...
var SciChartPolarSubSurface_1 = require("../SciChartPolarSubSurface");
var SciChartSubSurface_1 = require("../SciChartSubSurface");
/**
...
var SciChartLegendBase = /** @class */ (function (_super) {
    ...
    SciChartLegendBase.prototype.attachTo = function (sciChartSurface) {
        ...
        if (sciChartSurface instanceof SciChartSubSurface_1.SciChartSubSurface || sciChartSurface instanceof SciChartPolarSubSurface_1.SciChartPolarSubSurface) {
            this.lastViewportSize = sciChartSurface.renderSurface.viewportSize;
            sciChartSurface.preRender.subscribe(this.onResize);
        }
    };
    SciChartLegendBase.prototype.detach = function () {
        ...
        if (this.lastViewportSize) {
            this.parentSurfaceProperty.preRender.unsubscribe(this.onResize);
        }
        this.setInvalidateParentSurface(undefined);
        this.setParentSurface(undefined);
        this.delete();
    };
    SciChartLegendBase.prototype.onResize = function () {
        var viewPortSize = this.parentSurface.renderSurface.viewportSize;
        if (!Size_1.Size.isEqual(this.lastViewportSize, viewPortSize)) {
    ...
    Object.defineProperty(SciChartLegendBase.prototype, "parentSurface", {
        /**
         * Gets a reference to the parent {@link ISciChartSurfaceBase}
         */
        get: function () {

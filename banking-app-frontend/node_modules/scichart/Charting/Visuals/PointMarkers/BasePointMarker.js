...
var BasePointMarker = /** @class */ (function (_super) {
    ...
    function BasePointMarker(webAssemblyContext, options) {
        ...
        _this.antiAliasProperty = (_h = options === null || options === void 0 ? void 0 : options.antiAlias) !== null && _h !== void 0 ? _h : _this.antiAliasProperty;
    ...
    Object.defineProperty(BasePointMarker.prototype, "antiAlias", {
        /**
         * Gets or sets if anti-aliasing should be applied to the pointmarker.  Default true.
         */
        get: function () {
            return this.antiAliasProperty;
        },
        /**
         * Gets or sets if anti-aliasing should be applied to the pointmarker.  Default true.
         */
        set: function (antiAlias) {
            var oldValue = this.antiAliasProperty;
            this.antiAliasProperty = antiAlias;
            this.notifyPropertyChanged(Constants_1.PROPERTY.ANTIALIAS, antiAlias, oldValue);
        },
        enumerable: false,
        configurable: true
    });

...
var SeriesAnimation = /** @class */ (function () {
    ...
    SeriesAnimation.prototype.calculateDataSeriesAnimationValues = function (wasmContext, initialValues, finalValues, interpolatedValues, progress) {
        ...
        var initalView = (0, vectorToArray_1.vectorToArrayViewF64)(initialValues, wasmContext);
        var finalView = (0, vectorToArray_1.vectorToArrayViewF64)(finalValues, wasmContext);
        var interpolatedView = (0, vectorToArray_1.vectorToArrayViewF64)(interpolatedValues, wasmContext);
        for (var i = 0; i < size; i++) {
            interpolatedView[i] = animationHelpers_1.animationHelpers.interpolateNumber(initalView[i], finalView[i], progress);
        }
    };
    /**

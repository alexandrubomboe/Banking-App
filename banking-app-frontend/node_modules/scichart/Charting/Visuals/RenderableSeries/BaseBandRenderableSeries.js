...
var BaseBandRenderableSeries = /** @class */ (function (_super) {
    ...
    BaseBandRenderableSeries.prototype.getYRange = function (xVisibleRange, isXCategoryAxis) {
        ...
        if (this.renderDataTransform && this.renderDataTransform.useForYRange) {
            ...
            return (0, BaseDataSeries_1.getWindowedYRange)(this.webAssemblyContext, this.transformedRenderPassData.pointSeries.xValues, this.transformedRenderPassData.pointSeries.yValues, xVisibleRange, true, isXCategoryAxis, this.dataSeries.dataDistributionCalculator.isSortedAscending, this.dataSeries.dataDistributionCalculator.containsNaN);
        }
        ...
        if (pointSeries) {
            ...
            return (0, XyyDataSeries_1.getYyYRange)(this.webAssemblyContext, indicesRange, yValues, y1Values, this.dataSeries.dataDistributionCalculator.containsNaN);
        }

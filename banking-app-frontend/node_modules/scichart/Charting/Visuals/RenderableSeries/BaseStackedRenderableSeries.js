...
var BaseStackedRenderableSeries = /** @class */ (function (_super) {
    ...
    function BaseStackedRenderableSeries(webAssemblyContext, options) {
        ...
        _this.bottomAccumulatedValues = new webAssemblyContext.SCRTDoubleVector();
    ...
    BaseStackedRenderableSeries.prototype.delete = function () {
        ...
        this.bottomAccumulatedValues = (0, Deleter_1.deleteSafe)(this.bottomAccumulatedValues);
    ...
    BaseStackedRenderableSeries.prototype.onDetachFromParentCollection = function () {
        ...
        // Do not delete here.  Collection remove will delete if requrested
    };
    /**
     * @inheritDoc
     */
    ...
    BaseStackedRenderableSeries.prototype.beforeAnimationStart = function () {
        ...
        (0, copyVector_1.copyDoubleVector)(this.accumulatedValues, this.accumulatedFinalAnimationValues, this.webAssemblyContext);
    };
    /**

...
var BandSeriesDataLabelProvider = /** @class */ (function (_super) {
    ...
    BandSeriesDataLabelProvider.prototype.getPosition = function (state, textBounds) {
        if (this.singleLabel) {
            ...
            var pos = (0, text_1.getNativeTextPosition)(x, yPos, this.horizontalTextPositionToAnchorPoint(this.horizontalTextPosition), this.verticalTextPositionToAnchorPoint(this.verticalTextPosition), textBounds, this.getPadding());

...
export declare class DataLabelProvider extends BaseDataLabelProvider {
    ...
    protected horizontalTextPositionToAnchorPoint(horizontalPosition: EHorizontalTextPosition): EHorizontalAnchorPoint;
    protected verticalTextPositionToAnchorPoint(verticalPosition: EVerticalTextPosition): EVerticalAnchorPoint;
    protected getPadding(): Thickness;

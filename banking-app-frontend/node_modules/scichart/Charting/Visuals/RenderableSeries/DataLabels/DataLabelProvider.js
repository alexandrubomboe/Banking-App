...
var DataLabelProvider = /** @class */ (function (_super) {
    ...
    DataLabelProvider.prototype.shouldGenerate = function (state) {
        ...
        state.font.CalculateStringBounds(firstlabel !== null && firstlabel !== void 0 ? firstlabel : "", bounds, this.getLineSpacing());
    ...
    DataLabelProvider.prototype.getPosition = function (state, textBounds) {
        ...
        var pos = (0, text_1.getNativeTextPosition)(x, y, this.horizontalTextPositionToAnchorPoint(this.horizontalTextPosition), this.verticalTextPositionToAnchorPoint(this.verticalTextPosition), textBounds, this.getPadding());
        return { position: new Point_1.Point(pos.x, pos.y), rotationAngle: 0, rotationCenter: rotationCenter };
    };
    ...
    DataLabelProvider.prototype.generateDataLabels = function (renderContext, renderPassData) {
        ...
        var _a = this.parentSeries.dataSeries, fifoCapacity = _a.fifoCapacity, fifoSweeping = _a.fifoSweeping, fifoSweepingGap = _a.fifoSweepingGap, fifoStartIndex = _a.fifoStartIndex;
        var bounds = (0, NativeObject_1.getTextBounds)(this.webAssemblyContext);
        ...
        for (var i = this.state.indexStart; i <= this.state.indexEnd; i += skipNum + 1) {
            ...
            if (!text)
                continue;
            this.state.font.CalculateStringBounds(text !== null && text !== void 0 ? text : "", bounds, this.getLineSpacing());
            // console.log(text, bounds.m_fHeight, bounds.GetLinesCount());
            var _b = this.getPosition(this.state, bounds), position = _b.position, rotationAngle = _b.rotationAngle, rotationCenter = _b.rotationCenter;
            var color = this.getColor(this.state, text);
            var lineBounds = bounds.GetLineBounds(0);
            var firstLineHeight = lineBounds.m_fHeight;
            lineBounds.delete();
            var label = {
                text: text,
                position: position,
    ...
    DataLabelProvider.prototype.horizontalTextPositionToAnchorPoint = function (horizontalPosition) {
        if (horizontalPosition === TextPosition_1.EHorizontalTextPosition.Left) {
            return AnchorPoint_1.EHorizontalAnchorPoint.Right;
        }
        else if (horizontalPosition === TextPosition_1.EHorizontalTextPosition.Right) {
            return AnchorPoint_1.EHorizontalAnchorPoint.Left;
        }
        else {
            return AnchorPoint_1.EHorizontalAnchorPoint.Center;
        }
    };
    DataLabelProvider.prototype.verticalTextPositionToAnchorPoint = function (verticalPosition) {
        if (verticalPosition === TextPosition_1.EVerticalTextPosition.Above) {
            return AnchorPoint_1.EVerticalAnchorPoint.Bottom;
        }
        else if (verticalPosition === TextPosition_1.EVerticalTextPosition.Below) {
    ...
    DataLabelProvider.prototype.getPadding = function () {
        var _a;
        return (_a = this.style.padding) !== null && _a !== void 0 ? _a : Thickness_1.Thickness.fromNumber(0);
    };

...
var HeatMapDataLabelProvider = /** @class */ (function (_super) {
    ...
    HeatMapDataLabelProvider.prototype.getPosition = function (xIndex, yIndex, xVal, yVal, textSize, cellWidth, cellHeight, renderPassData) {
        ...
        if (renderPassData.isVerticalChart
            ? renderPassData.yCoordinateCalculator.hasFlippedCoordinates
            : renderPassData.xCoordinateCalculator.hasFlippedCoordinates) {
    ...
    HeatMapDataLabelProvider.prototype.generateDataLabels = function (renderContext, renderPassData) {
        ...
        font.CalculateStringBounds((_b = this.getText(0, 0)) !== null && _b !== void 0 ? _b : "", bounds, this.getLineSpacing());
        if (renderPassData.isVerticalChart) {
        ...
        var _c = this.parentSeries.dataSeries, xStart = _c.xStart, xStep = _c.xStep, yStart = _c.yStart, yStep = _c.yStep;
        for (var yIndex = 0; yIndex < this.dataSeries.arrayHeight; yIndex++) {
            ...
            for (var xIndex = 0; xIndex < this.dataSeries.arrayWidth; xIndex++) {
                ...
                font.CalculateStringBounds(text !== null && text !== void 0 ? text : "", bounds, this.getLineSpacing());
                ...
                var _d = this.getPosition(xIndex, yIndex, xVal, yVal, textSize, cellWidth, cellHeight, renderPassData), position = _d.position, rotationCenter = _d.rotationCenter, rotationAngle = _d.rotationAngle;
                var lineBounds = bounds.GetLineBounds(0);
                var label = {
                    text: text,
                    position: position,
                    rect: new Rect_1.Rect(position.x, position.y - lineBounds.m_fHeight, textSize.width, textSize.height),

...
var TextDataLabelProvider = /** @class */ (function (_super) {
    ...
    TextDataLabelProvider.prototype.generateDataLabels = function (renderContext, renderPassData) {
        ...
        var _b = this.parentSeries.dataSeries, fifoCapacity = _b.fifoCapacity, fifoSweeping = _b.fifoSweeping, fifoSweepingGap = _b.fifoSweepingGap, fifoStartIndex = _b.fifoStartIndex;
        ...
        if (textSeries) {
            this.state.font.CalculateStringBounds((_a = textSeries.getTextValue(0)) !== null && _a !== void 0 ? _a : "", bounds, this.getLineSpacing());

...
var NonUniformHeatmapDrawingProvider = /** @class */ (function (_super) {
    ...
    NonUniformHeatmapDrawingProvider.prototype.draw = function (renderContext, renderPassData) {
        ...
        if (!isOutViewport && !isOverflow) {
            ...
            var getXCoordFn = function (x) { return x; };
            if (this.parentSeries.xAxis.type === AxisType_1.EAxisType.BaseValueAxis || this.parentSeries.xAxis.type === AxisType_1.EAxisType.DiscontinuousDateAxis) {
                getXCoordFn = function (x) { return renderPassData.xCoordinateCalculator.getCoordinate(x); };
            }
            this.drawHeatmapInTypescript(renderContext, dataSeries.xCellOffsets, dataSeries.yCellOffsets, zValues, renderPassData.xCoordinateCalculator, renderPassData.yCoordinateCalculator, {
                ...
                // TS specific
                xCellSizes: dataSeries.getXCellSizes(getXCoordFn),
                yCellSizes: dataSeries.getYCellSizes(),
    ...
    NonUniformHeatmapDrawingProvider.prototype.drawHeatmapInTypescript = function (renderContext, xSpacings, ySpacings, zValues, xCalc, yCalc, params) {
        ...
        if (isVerticalChart) {
            ...
            renderContext.setTranslationRotationAndClip(clipRect, seriesViewRect.x - visibleTextureHeight, seriesViewRect.y + xMaxCoordinate + (hasFlippedX ? 0 : visibleTextureWidth), -90);
            ...
            renderContext.drawTexture(texture, x, y, visibleTextureWidth, visibleTextureHeight);
            // Uniform Heatmap approach
            // renderContext.drawTexture(texture, x, y, width, height);
            return;
        }

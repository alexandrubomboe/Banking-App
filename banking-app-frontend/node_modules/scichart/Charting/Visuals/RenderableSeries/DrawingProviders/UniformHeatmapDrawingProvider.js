...
var UniformHeatmapDrawingProvider = /** @class */ (function (_super) {
    ...
    UniformHeatmapDrawingProvider.prototype.draw = function (renderContext, renderPassData) {
        ...
        //     renderContext.drawTexture(this.paletteTexture.getTexture(), 0, 0, 256, 10);
        // }
        // END DEBUG CODE
        var _a;
        ...
        if (heatTexture) {
            ...
            // renderContext.drawTexture(heatTexture, 10, 100, 256, 256);
            // renderContext.drawTexture(this.paletteTexture.getTexture(), 310, 100, 256, 256);
            // END DEBUG CODE
            ...
            if (isVerticalChart) {
                ...
                renderContext.setTranslationRotationAndClip(clipRect, seriesViewRect.x, seriesViewRect.y + textureWidth + (hasFlippedXCoordinates ? xMax : xMin), -90);
                var x = hasFlippedXCoordinates ? 0 : textureWidth;
                var width = hasFlippedXCoordinates ? textureWidth : 0;
                var y = yMin;
                var height = yMax;
                // TODO refactor naming - the function actually accepts x1, y1, x2, y2
    ...
    UniformHeatmapDrawingProvider.prototype.drawHeatmap = function (nativeContext, x, y, width, height) {
        ...
        var topLeft = (0, NativeObject_1.getTextureVertex)(this.webAssemblyContext, width, y, app_1.NEUTRAL_COLOR, 1, 0);
        quadVerts.push_back(topLeft);
        var bottomRight = (0, NativeObject_1.getTextureVertex)(this.webAssemblyContext, x, height, app_1.NEUTRAL_COLOR, 0, 1);
        quadVerts.push_back(bottomRight);
        var topRight = (0, NativeObject_1.getTextureVertex)(this.webAssemblyContext, width, height, app_1.NEUTRAL_COLOR, 1, 1);
        ...
        drawParams.SetGradientTexture(this.paletteTexture.getTexture());
        drawParams.SetHeightMapTexture(heatTexture);
        drawParams.m_vPackedFloatParams = v4;
        drawParams.SetContourParams(contourParams);
        drawParams.m_Effect = this.webAssemblyContext.SCRTPrimitivesEffect.Heatmap;

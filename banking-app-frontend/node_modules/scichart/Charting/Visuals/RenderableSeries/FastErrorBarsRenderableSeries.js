...
var FastErrorBarsRenderableSeries = /** @class */ (function (_super) {
    ...
    FastErrorBarsRenderableSeries.prototype.getDataPointWidth = function (coordCalc, widthFraction, widthMode) {
        ...
        if (widthMode === DataPointWidthMode_1.EDataPointWidthMode.Range) {
            ...
            // Relative
            var pointWidth = Math.floor((0, BaseRenderableSeries_1.getDataPointWidth)(values, coordCalc, seriesViewRectWidth, widthFraction, isCategoryAxis, isVerticalDirection && this.dataSeries.dataDistributionCalculator.isSortedAscending, this.webAssemblyContext));
            if (pointWidth % 2 !== 0) {
                pointWidth -= 1;
            }
            if (pointWidth <= 1) {

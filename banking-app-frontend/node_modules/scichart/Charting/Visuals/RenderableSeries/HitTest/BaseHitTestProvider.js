...
var BaseHitTestProvider = /** @class */ (function () {
    ...
    BaseHitTestProvider.prototype.hitTestDataPoint = function (x, y, hitTestRadius) {
        ...
        var dataY = this.parentSeries.getNativeYValues();
        var nearest = hitTestHelpers_1.hitTestHelpers.getNearestPoint(this.webAssemblyContext, xCoordinateCalculator, yCoordinateCalculator, dataX, dataY, dataSeries.dataDistributionCalculator.isSortedAscending, xHitCoord, yHitCoord, hitTestRadius);

...
var BaseRenderDataTransform = /** @class */ (function (_super) {
    ...
    BaseRenderDataTransform.prototype.runTransform = function (renderPassData) {
        ...
        if (this.requiresTransform ||
            ...
            var mark = performance_1.PerformanceDebugHelper.mark(performance_1.EPerformanceMarkType.RenderDataTransformStart, {
                contextId: this.parentSeries.id,
                parentContextId: (_a = this.parentSeries.parentSurface) === null || _a === void 0 ? void 0 : _a.id,
                level: performance_1.EPerformanceDebugLevel.Verbose
            });
            var ps = this.runTransformInternal(renderPassData);
            performance_1.PerformanceDebugHelper.mark(performance_1.EPerformanceMarkType.RenderDataTransformEnd, {
                contextId: this.parentSeries.id,
                parentContextId: (_b = this.parentSeries.parentSurface) === null || _b === void 0 ? void 0 : _b.id,

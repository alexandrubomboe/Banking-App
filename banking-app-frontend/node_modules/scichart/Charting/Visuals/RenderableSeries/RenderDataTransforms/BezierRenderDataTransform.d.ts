...
export declare const bezierTransform: (oldX: Float64Array, oldY: Float64Array, iStart: number, iEnd: number, interpolationPoints: number, curvature: number, y1Values?: Float64Array) => {
    newxValues: number[];
    newyValues: number[];
    newindexes: number[];
};

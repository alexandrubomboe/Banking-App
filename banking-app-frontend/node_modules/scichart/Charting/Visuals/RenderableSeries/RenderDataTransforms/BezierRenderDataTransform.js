...
var bezierTransform = function (oldX, oldY, iStart, iEnd, interpolationPoints, curvature, y1Values) {
    var _a, _b;
    var oldXSize = oldX.length;
    var newxValues = [];
    var newyValues = [];
    var newindexes = [];
    ...
    var getPoint = function (i) { return ({ x: oldX[i], y: oldY[i] }); };
    ...
    var pAfter = getPoint(Math.min(iStart + 2, oldXSize - 1));
    var p3;
    var index = 0;
    ...
    newindexes.push(index);
    return { newxValues: newxValues, newyValues: newyValues, newindexes: newindexes };
};
...
var BezierRenderDataTransform = /** @class */ (function (_super) {
    ...
    BezierRenderDataTransform.prototype.runTransformInternal = function (renderPassData) {
        ...
        yValues.clear();
        indexes.clear();
        var _d = (0, exports.bezierTransform)((0, vectorToArray_1.vectorToArrayViewF64)(oldX, this.wasmContext), (0, vectorToArray_1.vectorToArrayViewF64)(oldY, this.wasmContext), iStart, iEnd, this.interpolationPoints, this.curvature), newxValues = _d.newxValues, newyValues = _d.newyValues, newindexes = _d.newindexes;
        (0, appendDoubleVectorFromJsArray_1.appendDoubleVectorFromJsArray)(this.wasmContext, xValues, newxValues);
        (0, appendDoubleVectorFromJsArray_1.appendDoubleVectorFromJsArray)(this.wasmContext, yValues, newyValues);
        (0, appendDoubleVectorFromJsArray_1.appendDoubleVectorFromJsArray)(this.wasmContext, indexes, newindexes);
...
var XyyBezierRenderDataTransform = /** @class */ (function (_super) {
    ...
    XyyBezierRenderDataTransform.prototype.runTransformInternal = function (renderPassData) {
        ...
        y1Values.clear();
        indexes.clear();
        var _d = (0, exports.bezierTransform)((0, vectorToArray_1.vectorToArrayViewF64)(oldX, this.wasmContext), (0, vectorToArray_1.vectorToArrayViewF64)(oldY1, this.wasmContext), iStart, iEnd, this.interpolationPoints, this.curvature), newxValues1 = _d.newxValues, newyValues1 = _d.newyValues, newindexes1 = _d.newindexes;
        // Only need y1 here as x and y done below
        (0, appendDoubleVectorFromJsArray_1.appendDoubleVectorFromJsArray)(this.wasmContext, y1Values, newyValues1);
        var _e = (0, exports.bezierTransform)((0, vectorToArray_1.vectorToArrayViewF64)(oldX, this.wasmContext), (0, vectorToArray_1.vectorToArrayViewF64)(oldY, this.wasmContext), iStart, iEnd, this.interpolationPoints, this.curvature, this.forceYGreaterThanY1 ? (0, vectorToArray_1.vectorToArrayViewF64)(y1Values, this.wasmContext) : undefined), newxValues = _e.newxValues, newyValues = _e.newyValues, newindexes = _e.newindexes;
        (0, appendDoubleVectorFromJsArray_1.appendDoubleVectorFromJsArray)(this.wasmContext, xValues, newxValues);
        (0, appendDoubleVectorFromJsArray_1.appendDoubleVectorFromJsArray)(this.wasmContext, yValues, newyValues);
        (0, appendDoubleVectorFromJsArray_1.appendDoubleVectorFromJsArray)(this.wasmContext, indexes, newindexes);
        return this.pointSeries;

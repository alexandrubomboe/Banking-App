...
var rolloverTooltipSvgAnnotationHelpers_1 = require("../../Annotations/rolloverTooltipSvgAnnotationHelpers");
...
var RolloverModifierRenderableSeriesProps = /** @class */ (function () {
    ...
    /**
     * Calculates tooltip width from the longest text line length.
     * Override this if using a custom tooltipTemplate with different sizing.
     */
    RolloverModifierRenderableSeriesProps.prototype.calcTooltipWidth = function (textLength) {
        return (0, rolloverTooltipSvgAnnotationHelpers_1.calcTooltipWidth)(textLength);
    };
    /**
     * Calculates tooltip height from the number of text lines.
     * Override this if using a custom tooltipTemplate with different sizing.
     */
    RolloverModifierRenderableSeriesProps.prototype.calcTooltipHeight = function (lines) {
        return (0, rolloverTooltipSvgAnnotationHelpers_1.calcTooltipHeight)(lines);
    };
    /**
     * Pre-computes tooltip text lines and dimensions.
     * Called by calcTooltipProps before positioning to ensure correct first-render placement.
     * The resulting lines are cached on the tooltip annotation to avoid recomputation in the SVG template.
     */
    RolloverModifierRenderableSeriesProps.prototype.getTooltipSize = function (seriesInfo) {
        var _a, _b, _c, _d, _e;
        var dataTemplate = (_c = (_a = this.tooltipDataTemplate) !== null && _a !== void 0 ? _a : (_b = this.rolloverModifier) === null || _b === void 0 ? void 0 : _b.tooltipDataTemplate) !== null && _c !== void 0 ? _c : rolloverTooltipSvgAnnotationHelpers_1.defaultTooltipDataTemplate;
        var lines = dataTemplate(seriesInfo, this.tooltipTitle, this.tooltipLabelX, this.tooltipLabelY);
        // Cache lines on the annotation so the SVG template can reuse them
        if (this.tooltip) {
            this.tooltip.tooltipLines = lines;
        }
        var maxLen = lines.reduce(function (prev, cur) { return ((cur === null || cur === void 0 ? void 0 : cur.length) > prev ? cur.length : prev); }, 0);
        var width = (_d = this.width) !== null && _d !== void 0 ? _d : this.calcTooltipWidth(maxLen);
        var height = (_e = this.height) !== null && _e !== void 0 ? _e : this.calcTooltipHeight(lines.length);

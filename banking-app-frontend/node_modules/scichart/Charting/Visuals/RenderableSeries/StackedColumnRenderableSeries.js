...
var StackedColumnSeriesDrawingProvider_1 = require("./DrawingProviders/StackedColumnSeriesDrawingProvider");
/**
...
var StackedColumnRenderableSeries = /** @class */ (function (_super) {
    ...
    function StackedColumnRenderableSeries(webAssemblyContext, options) {
        ...
        if ((_j = _this.paletteProvider) === null || _j === void 0 ? void 0 : _j.onAttached) {
            (_k = _this.paletteProvider) === null || _k === void 0 ? void 0 : _k.onAttached(_this);
        }
        return _this;
    }
    StackedColumnRenderableSeries.prototype.addDrawingProviders = function (webAssemblyContext, options) {
        this.drawingProviders.push(new StackedColumnSeriesDrawingProvider_1.StackedColumnSeriesDrawingProvider(webAssemblyContext, this));
    };
    // PUBLIC
    /**
     * @inheritDoc
    ...
    // PROPERTIES END
    StackedColumnRenderableSeries.prototype.draw = function (renderContext, renderPassData) {
        var _this = this;
        var _a;
        var viewRect = (_a = this.parentSurface) === null || _a === void 0 ? void 0 : _a.seriesViewRect;
        this.drawingProviders.forEach(function (dp) {
            var _a;
            if ((_a = _this.xAxis) === null || _a === void 0 ? void 0 : _a.isVerticalChart) {
                if (viewRect)
                    renderContext.setTranslationRotationAndClip(viewRect, viewRect.x, viewRect.y);
            }

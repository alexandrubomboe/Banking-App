...
var BaseValueAxis_1 = require("./Axis/BaseValueAxis");
var CategoryAxis_1 = require("./Axis/CategoryAxis");
var DiscontinuousDateAxis_1 = require("./Axis/DiscontinuousDateAxis");
var LogarithmicAxis_1 = require("./Axis/LogarithmicAxis");
var NumericAxis_1 = require("./Axis/NumericAxis");
var BaseStackedCollection_1 = require("./RenderableSeries/BaseStackedCollection");
...
var createSciChartOverview = function (originalSciChartSurface, overviewRootElement, options) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, wasmContext, sciChartSurface, mainAxisId, secondaryAxisId, originalMainAxis, originalSecondaryAxis, originalXAxis, originalYAxis, xAxisOptions, yAxisOptions, xAxis, yAxis, mainOverviewAxis, transform, renderableSeries, rangeSelectionModifier;
    var _b;
    var _c, _d, _e;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 1:
                _a = _f.sent(), wasmContext = _a.wasmContext, sciChartSurface = _a.sciChartSurface;
                ...
                xAxis = originalXAxis.isCategoryAxis
                    ...
                    : originalXAxis.type === AxisType_1.EAxisType.BaseValueAxis
                        ? new BaseValueAxis_1.BaseValueAxis(wasmContext, xAxisOptions)
                        : originalXAxis.type === AxisType_1.EAxisType.DiscontinuousDateAxis
                            ? new DiscontinuousDateAxis_1.DiscontinuousDateAxis(wasmContext, xAxisOptions)
                ...
                yAxis = originalYAxis.isCategoryAxis
                    ...
                    : originalYAxis.type === AxisType_1.EAxisType.BaseValueAxis
                        ? new BaseValueAxis_1.BaseValueAxis(wasmContext, yAxisOptions)
                        : originalYAxis.type === AxisType_1.EAxisType.DiscontinuousDateAxis
                            ? new DiscontinuousDateAxis_1.DiscontinuousDateAxis(wasmContext, yAxisOptions)
                            : originalYAxis.type === AxisType_1.EAxisType.LogarithmicAxis
                ...
                transform = function (rendSeries) {
                    ...
                    if (rendSeries instanceof BaseStackedCollection_1.BaseStackedCollection) {
                        var overviewCollection = (0, buildSeries_1.buildSeries)(wasmContext, rendSeries.toJSON(true))[0];
                        overviewCollection.asArray().forEach(function (child, i) {
                            child.dataSeries.delete();
                            child.dataSeries = rendSeries.asArray()[i].dataSeries;
                        });
                        overviewCollection.xAxisId = xAxis.id;
                        overviewCollection.yAxisId = yAxis.id;
                ...
                if (options === null || options === void 0 ? void 0 : options.transformRenderableSeries) {
                    transform = function (rs) { return options === null || options === void 0 ? void 0 : options.transformRenderableSeries(rs, sciChartSurface); };
                }
                //  Add axes before series so they are available as surface.getDefaultXAxis, surface.getDefaultYAxis
                ...
                rangeSelectionModifier = (_e = options === null || options === void 0 ? void 0 : options.customRangeSelectionModifier) !== null && _e !== void 0 ? _e : new OverviewRangeSelectionModifier_1.OverviewRangeSelectionModifier();
                ...
                sciChartSurface.layoutMeasured.subscribe(function () {
                    rangeSelectionModifier.selectedArea = new NumberRange_1.NumberRange(Math.max(xAxis.visibleRange.min, originalMainAxis.visibleRange.min), Math.min(xAxis.visibleRange.max, originalMainAxis.visibleRange.max));
                });

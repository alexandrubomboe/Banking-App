...
export interface IPieSurfaceOptions extends ISurfaceOptionsBase {
    ...
    /**
     * Sets the corner radius for pie/donut segments.
     * @note For {@link EPieType.Pie} charts, the inner angle will not be rounded, whereas for {@link EPieType.Donut} charts, all 4 corners will.
     *
     * Default `0`
     */
    cornerRadius?: number;

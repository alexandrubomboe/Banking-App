...
export declare class TextureManager extends DeletableEntity implements IDeletable {
    ...
    createSimpleTextTexture(text: string, textStyle: TTextStyle, backgroundColor?: string, displayVertically?: boolean, displayMirrored?: boolean, opacity?: number, cornerRadius?: number): TTextureObject;
    /**
     ...
     * @returns
     */
    createTextTexture(text: string[], textStyle: TTextStyle, rotation?: number, lineSpacing?: number, backgroundColor?: string, opacity?: number, cornerRadius?: number): TTextureObject;
    ...
    createFilledRectTexture(width: number, height: number, backgroundColor: string, cornerRadius?: number, opacity?: number): TTextureObject;

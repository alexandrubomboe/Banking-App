...
var TextureManager = /** @class */ (function (_super) {
    ...
    TextureManager.prototype.createSimpleTextTexture = function (text, textStyle, backgroundColor, displayVertically, displayMirrored, opacity, cornerRadius) {
        var rotation = 0;
        ...
        return this.createTextTexture([text], textStyle, rotation, undefined, backgroundColor, opacity, cornerRadius);
    };
    /**
    ...
    TextureManager.prototype.createTextTextureNative = function (text, textStyle, rotation, lineSpacing, backgroundColor, opacity) {
        ...
        var bitmapTexture = nativeContext.CreateTextTexture(fontKey, text.join("\n"), (0, parseColor_1.parseColorToUIntArgb)(color), bgColor);
     ...
     * @returns
     */
    TextureManager.prototype.createTextTexture = function (text, textStyle, rotation, lineSpacing, backgroundColor, opacity, cornerRadius) {
        var _a;
        if (app_1.IS_TEST_ENV) {
        ...
        var lineSpacingPixels = (0, text_1.convertToNativeLineSpacing)(maxLineHeight, lineSpacing !== null && lineSpacing !== void 0 ? lineSpacing : 1.1);
        ...
        if (backgroundColor) {
            ...
            var w = textureWidth;
            var h = textureHeight;
            var r = Math.min(cornerRadius * DpiHelper_1.DpiHelper.PIXEL_RATIO, w / 2, h / 2);
            if (r > 0) {
                this.ctx.beginPath();
                this.ctx.moveTo(r, 0);
    ...
    TextureManager.prototype.createFilledRectTexture = function (width, height, backgroundColor, cornerRadius, opacity) {
        ...
        var ctx = this.getTextureContext(textureWidth, textureHeight);
        if (!ctx) {
            return { bitmapTexture: undefined, textureWidth: 1, textureHeight: 1 };
        }
        ctx.save();
        ...
        var r = Math.min((cornerRadius !== null && cornerRadius !== void 0 ? cornerRadius : 0) * DpiHelper_1.DpiHelper.PIXEL_RATIO, textureWidth / 2, textureHeight / 2);
        if (r > 0) {
            ctx.beginPath();
            ctx.moveTo(r, 0);
            ctx.lineTo(textureWidth - r, 0);
            ctx.quadraticCurveTo(textureWidth, 0, textureWidth, r);
            ctx.lineTo(textureWidth, textureHeight - r);
            ctx.quadraticCurveTo(textureWidth, textureHeight, textureWidth - r, textureHeight);
            ctx.lineTo(r, textureHeight);
            ctx.quadraticCurveTo(0, textureHeight, 0, textureHeight - r);
            ctx.lineTo(0, r);
...
var measureTextWidth = function (ctx, text) {
    ...
    // console.warn("measureTextWidth: No context provided"); // should we add this?
    return 0;
};

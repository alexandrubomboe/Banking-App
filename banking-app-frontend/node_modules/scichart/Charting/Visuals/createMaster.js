    ...
    return __generator(this, function (_h) {
        switch (_h.label) {
            ...
            case 2:
                ...
                wasmContext_1.TSRSetDrawRequestsEnabled((_f = !(options === null || options === void 0 ? void 0 : options.disableEngineLoop)) !== null && _f !== void 0 ? _f : true);
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                (0, exports.monitorWebGL)(master.wasmContext, true);
                _c.label = 2;
            case 2:
...
/** @ignore */
var monitorWebGL = function (wasmContext, isMaster) {
    var getDestinations = function () {
        if (isMaster) {
            return Globals_1.sciChartDestinations;
        }
        else {
            return Globals_1.sciChartSingleDestinations;
        }
    };
    var restoreContext = function () {
        // restart the engine
        wasmContext.SCRTInitEngine2D();
        for (var _i = 0, _a = getDestinations(); _i < _a.length; _i++) {
            var dest = _a[_i];
            dest.sciChartSurface.isWebGLContextActive = true;
    ...
    var webGLLostContextEventHandler = function (event) {
        ...
        for (var _i = 0, _a = getDestinations(); _i < _a.length; _i++) {
            var dest = _a[_i];
            dest.sciChartSurface.isWebGLContextActive = false;
        }
...
var createMaster = function () {
    ...
    return new Promise(function (resolve, reject) {
        ...
        // @ts-ignore
        new WasmModule2D({ locateFile: locateFile, noInitialRun: true, canvas: canvas, preRun: preRun_1.preRun })
            ...
            licenseManager2D_1.licenseManager.applyLicense(wasmContext, "2D master");
            ...
            var createChildSurface = function (divElementId, canvases, theme, surfaceConstructor) {
                ...
                sciChartSurface.addDeletable({
                    delete: function () {
                        ...
                        if (SciChartSurface_1.SciChartSurface.autoDisposeWasmContext &&
                            (0, Globals_1.getOther2DMultiChartDestinations)(sciChartSurface).length === 0) {
                            ...
                            try {
                                if (process.env.NODE_ENV !== "production") {
                                    if (MemoryUsageHelper_1.MemoryUsageHelper.isMemoryUsageDebugEnabled &&
                                        (0, Globals_1.getOther2DMultiChartDestinations)(sciChartSurface).length === 0) {
                                        performanceWarnings_1.performanceWarnings.wasmContextAutoDisposeDisabled.warn();
                                    }
                                }
                            }
                            catch (err) {
                ...
                licenseManager2D_1.licenseManager.updateLicenseDisplay(sciChartSurface);
                return sciChartSurface;
            };

...
export declare class XyzDataSeries3D extends BaseDataSeries3D {
    ...
    /**
     * Gets a js array of {@link IPointMetadata3D | Metadata values} in the DataSeries
     */
     ...
     */
    appendRange(xValues: NumberArray, yValues: NumberArray, zValues: NumberArray, metadatas?: IPointMetadata3D[]): void;
    /**
     ...
     */
    insertRange(startIndex: number, xValues: NumberArray, yValues: NumberArray, zValues: NumberArray, metadatas?: IPointMetadata3D[]): void;
    /**
     ...
     */
    setMetadataAt(index: number, metadata: IPointMetadata3D): void;
    /**
     * Sets metadata for all points without changing X, Y, Z values
     * @remarks Any changes of the DataSeries will trigger a redraw on the parent {@link SciChart3DSurface}
     * @param metadatas The array of new metadata values. Must have the same length as the current data series
     */
    setMetadata(metadatas: IPointMetadata3D[]): void;
    /**
     * @inheritDoc
     */
    delete(): void;
     ...
     * @param size The number of data-points to reserve memory for
     */

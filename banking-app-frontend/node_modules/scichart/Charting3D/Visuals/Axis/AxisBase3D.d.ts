...
import { E3DLabelOrientationMode, E3DTitleRotationMode, TTextStyleBase3D } from "../../../types/TextStyle3D";
...
export interface IAxisBase3dOptions extends IAxisCoreOptions, ILabelOptions {
    ...
    /**
     * Orientation mode for axis labels. Default horizontal.
     */
    labelOrientationMode?: E3DLabelOrientationMode;
    /**
     * Orientation mode for axis titles. Default horizontal.
     */
    titleOrientationMode?: E3DTitleRotationMode;
}
/**
...
export declare abstract class AxisBase3D extends AxisCore implements IThemeable {
    ...
    private labelOrientationModeProperty;
    private titleOrientationModeProperty;
    /**
    ...
    /**
     * Gets or sets axis label orientation mode
     */
    get labelOrientationMode(): E3DLabelOrientationMode;
    /**
     * Gets or sets axis label orientation mode
     */
    set labelOrientationMode(value: E3DLabelOrientationMode);
    /**
     * Gets or sets axis title orientation mode
     */
    get titleOrientationMode(): E3DTitleRotationMode;
    /**
     * Gets or sets axis title orientation mode
     */
    set titleOrientationMode(value: E3DTitleRotationMode);

...
var BaseSceneEntity3D = /** @class */ (function (_super) {
    ...
    /**
     * Create or get a cached vector
     * @param existingVector the existing vector
     * @param requiredSize the desired size. Will be resized
     * @param ctor constructor function
     * @param defaultValue the default value to use when resizing. Defaults to 0
     * @protected
     */
    BaseSceneEntity3D.prototype.getOrCreateVector = function (existingVector, requiredSize, ctor, defaultValue) {
        if (defaultValue === void 0) { defaultValue = 0; }
        var vector = existingVector !== null && existingVector !== void 0 ? existingVector : new ctor();
        if (vector.size() !== requiredSize)
            vector.resize(requiredSize, defaultValue);
        return vector;
    };

...
var PointLine3DSceneEntity = /** @class */ (function (_super) {
    ...
    function PointLine3DSceneEntity(webAssemblyContext, parentSeries) {
        ...
        _this.sceneEntityParams = new webAssemblyContext.SCRTPointLines3DSceneEntityParams();
        return _this;
    }
    /**
     * @inheritDoc
    ...
    PointLine3DSceneEntity.prototype.updateSeries = function () {
        ...
        this.pointColors = this.getOrCreateVector(this.pointColors, count, this.webAssemblyContext.SCRTUintVector, strokeArgb);
        this.pointScales = this.getOrCreateVector(this.pointScales, count, this.webAssemblyContext.SCRTFloatVector, 1.0);
        var _a = this.rebuildPointMetadata(this.pointColors, this.pointScales, meta, count, strokeArgb), hasDefaultColors = _a.hasDefaultColors, hasDefaultScales = _a.hasDefaultScales;
        ...
        this.nativeEntity.UpdateMeshesVec(xValues, yValues, zValues, this.pointColors, this.pointColors, this.pointScales, this.sceneEntityParams);
    };

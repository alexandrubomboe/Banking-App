...
var AxisPlane_1 = require("./AxisPlane");
var defaultSciChart3DConfig = {
    wasmUrl: "scichart3d.wasm",
    wasmNoSimdUrl: undefined
};
exports.sciChartConfig3D = defaultSciChart3DConfig;
/**
...
var SciChart3DSurface = /** @class */ (function (_super) {
    ...
    function SciChart3DSurface(webAssemblyContext, options) {
        ...
        _this.visibleRangeClipMin = new webAssemblyContext.TSRVector3(Number.NEGATIVE_INFINITY, Number.NEGATIVE_INFINITY, Number.NEGATIVE_INFINITY);
        _this.visibleRangeClipMax = new webAssemblyContext.TSRVector3(Number.MAX_VALUE, Number.MAX_VALUE, Number.MAX_VALUE);
     ...
     * Note if loading from CDN the version number of wasm Url must match the version number of SciChart.js you are using.
     * @example
     * ```ts
     * // 3D Charts
    ...
    SciChart3DSurface.configure = function (config) {
        var _a, _b;
        exports.sciChartConfig3D.wasmUrl = (_a = config === null || config === void 0 ? void 0 : config.wasmUrl) !== null && _a !== void 0 ? _a : defaultSciChart3DConfig.wasmUrl;
        exports.sciChartConfig3D.wasmNoSimdUrl = (_b = config === null || config === void 0 ? void 0 : config.wasmNoSimdUrl) !== null && _b !== void 0 ? _b : defaultSciChart3DConfig.wasmNoSimdUrl;
    };
    /**
    ...
    SciChart3DSurface.useWasmFromCDN = function () {
        ...
        exports.sciChartConfig3D.wasmNoSimdUrl = "https://cdn.jsdelivr.net/npm/scichart@".concat(BuildStamp_1.libraryVersion, "/_wasm/scichart3d-nosimd.wasm");
    };
    /**
     * Tell SciChart to load the Wasm files from CDN, rather than expecting them to be served by the host server.
     */
    ...
    SciChart3DSurface.loadWasmLocal = function () {
        return SciChart3DSurface.configure(defaultSciChart3DConfig);
    };
    /**
    ...
    SciChart3DSurface.prototype.delete = function (clearHtml) {
        ...
        this.visibleRangeClipMin = (0, Deleter_1.deleteSafe)(this.visibleRangeClipMin);
        this.visibleRangeClipMax = (0, Deleter_1.deleteSafe)(this.visibleRangeClipMax);
    ...
    Object.defineProperty(SciChart3DSurface.prototype, "isZXPlaneVisible", {
         ...
         */
        get: function () {
            return this.zxAxisPlaneProperty.isVisible;
        },
        set: function (value) {
            this.zxAxisPlaneProperty.isVisible = value;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SciChart3DSurface.prototype, "isXYPlaneVisible", {
         ...
         */
        get: function () {
            return this.xyAxisPlaneProperty.isVisible;
        },
        set: function (value) {
            this.xyAxisPlaneProperty.isVisible = value;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SciChart3DSurface.prototype, "isZYPlaneVisible", {
         ...
         */
        get: function () {
            return this.zyAxisPlaneProperty.isVisible;
        },
        set: function (value) {
            this.zyAxisPlaneProperty.isVisible = value;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SciChart3DSurface.prototype, "xyAxisPlane", {
        /** Settings for the XY Axis Plane */
        get: function () {
            return this.xyAxisPlaneProperty;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SciChart3DSurface.prototype, "zyAxisPlane", {
        /** Settings for the ZY Axis Plane */
        get: function () {
            return this.zyAxisPlaneProperty;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SciChart3DSurface.prototype, "zxAxisPlane", {
        /** Settings for the ZX Axis Plane */
        get: function () {
            return this.zxAxisPlaneProperty;
        },
        enumerable: false,
        configurable: true
    });
    ...
    SciChart3DSurface.prototype.invalidateElement = function (options) {
        ...
        if (!this.sciChart3DRenderer.isInvalidated) {
            ...
            // TODO need context loss tracking from createMaster/Single (like 2d) to avoid this check
    ...
    SciChart3DSurface.prototype.doDrawingLoop = function () {
        ...
        try {
            ...
            this.renderError.raiseEvent(err);
        }
    };
    /**
     * @inheritDoc
     ...
     */
    SciChart3DSurface.prototype.updateClipPlanes = function () {
        // In order to implement clipping similar to WPF check out Viewport3D.cs file in WPF solution
        // and apply coordinate calculators
        var sceneWorld = this.getSceneWorld();
        // Changing visibleRangeClipMin and visibleRangeClipMin possible to do clipping
        sceneWorld.SetVisibleRangeMin(this.visibleRangeClipMin);
        sceneWorld.SetVisibleRangeMax(this.visibleRangeClipMax);
        // by setting to True/False it is possible to enable/disable clip planes. But for 3D column chart it is always enabled in the shader
        sceneWorld.SetUseClipPlanes(false);
    };
    SciChart3DSurface.prototype.applyOptions = function (options) {
        ...
        this.xyAxisPlaneProperty = new AxisPlane_1.AxisPlane(this, AxisPlane_1.EAxisPlaneType.XY, options === null || options === void 0 ? void 0 : options.xyAxisPlane);
        this.zyAxisPlaneProperty = new AxisPlane_1.AxisPlane(this, AxisPlane_1.EAxisPlaneType.ZY, options === null || options === void 0 ? void 0 : options.zyAxisPlane);
        this.zxAxisPlaneProperty = new AxisPlane_1.AxisPlane(this, AxisPlane_1.EAxisPlaneType.ZX, options === null || options === void 0 ? void 0 : options.zxAxisPlane);
    };
    /**
     * @inheritDoc
     */
    ...
    SciChart3DSurface.prototype.getOptions = function () {
        ...
        var options = {
            ...
            xyAxisPlane: this.xyAxisPlaneProperty.toJSON(),
            zyAxisPlane: this.zyAxisPlaneProperty.toJSON(),
            zxAxisPlane: this.zxAxisPlaneProperty.toJSON()
        };
        return options;
    };
    /**

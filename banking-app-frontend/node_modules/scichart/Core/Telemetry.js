...
var shouldSendTelemetry = function () {
    ...
    if (licenseManager2dState_1.licenseManager2dState.licenseType !== licensingClasses_1.LicenseType.Community && !licenseManager2dState_1.licenseManager2dState.isDev)
        return false;
    // not if telemetry not enabled
    if (!licenseManager2dState_1.licenseManager2dState.telemetryEnabled)
        return false;
    // not if not online
...
var sendTelemetry = function () {
    ...
    var eventData = {
        ...
        data: {
            ...
            baseData: {
                ...
                properties: {
                    platform: "JS",
                    licenseType: licenseManager2dState_1.licenseManager2dState.licenseType,
                    orderId: licenseManager2dState_1.licenseManager2dState.orderId,
                    productCode: licenseManager2dState_1.licenseManager2dState.productCode,
                    isDev: licenseManager2dState_1.licenseManager2dState.isDev,
                    devCount: licenseManager2dState_1.licenseManager2dState.devCount,
    ...
    if (licenseManager2dState_1.licenseManager2dState.licenseType === licensingClasses_1.LicenseType.Community) {

export declare type TSciChart3D = {
    ...
    SCRTUintVector: new () => SCRTUintVector;
    eTSRTextureFormat: {
    ...
    NumberUtil: {
        ...
        MinMax: (inputValues: SCRTDoubleVector, containsNaN: boolean) => SCRTDoubleRange;
        MinMaxWithIndex: (inputValues: SCRTDoubleVector, startIndex: number, count: number, containsNaN: boolean) => SCRTDoubleRange;
        ...
        MinMaxPairWithIndex: (inputValues1: SCRTDoubleVector, inputValues2: SCRTDoubleVector, mult: number, multInv: number, startIndex: number, count: number, containsNaN: boolean) => SCRTDoubleRange;
    ...
    eSCRTAxisTitleRotationMode: {
        AxisTitleRotationAuto: eSCRTAxisTitleRotationMode;
        AxisTitleRotationVertical: eSCRTAxisTitleRotationMode;
        AxisTitleRotationHorizontal: eSCRTAxisTitleRotationMode;
    };
    eSCRTTickLabelOrientationMode: {
        TickLabelOrientationAuto: eSCRTTickLabelOrientationMode;
        TickLabelOrientationHorizontal: eSCRTTickLabelOrientationMode;
    };
    ...
    eAxisPlaneDrawTitlesMode: {
        AxisPlaneDrawTitlesBoth: eAxisPlaneDrawTitlesMode;
        AxisPlaneDrawTitlesHidden: eAxisPlaneDrawTitlesMode;
        AxisPlaneDrawTitlesLocalX: eAxisPlaneDrawTitlesMode;
        AxisPlaneDrawTitlesLocalY: eAxisPlaneDrawTitlesMode;
    };
    AxisPlaneVisibilityMode: {
        Auto: AxisPlaneVisibilityMode;
        PositiveSide: AxisPlaneVisibilityMode;
        NegativeSide: AxisPlaneVisibilityMode;
    };
...
export declare class SCRTUintVector {
    push_back(_dNewValue: number): void;
    resize(_iNewSize: number, _dInitialValue: number): void;
    resizeFast(_iNewSize: number): void;
    reserve(_iCount: number): void;
...
export declare class CoordinateCalculator {
    ...
    GetCoordinatesVec(_paDataValues: SCRTDoubleVector, _paOutput: SCRTFloatVector, _iSrcIndex: number, _iDestIndex: number, _iCount: number, _dOffset: number): void;
...
export declare class SCRTTextStyle {
    ...
    m_MultilineAlignment: eTSRTextAlignMode;
    m_fMultilineSpacing: number;
    delete(): void;
}
export declare class eTSRTextAlignMode {
}
export declare class eSCRTAxisTitleRotationMode {
}
export declare class eSCRTTickLabelOrientationMode {
}
/**
...
export declare class SCRTAxisDescriptor {
    ...
    SetLabelTextStyle(textStyle: SCRTTextStyle): void;
    ...
    GetLabelTextStylePtr(): SCRTTextStyle;
    m_strTitle: string;
    ...
    m_bBackgroundEnabled: boolean;
    m_bDepthIgnoreEnabled: boolean;
    m_fLabelsOffset: number;
    m_bSmoothLabelOverlapAvoidance: boolean;
    m_fBorderThickness: number;
    m_eTitleRotationMode: eSCRTAxisTitleRotationMode;
    m_eLabelsRotationMode: eSCRTTickLabelOrientationMode;
    delete(): void;
}
/**
...
export declare class SCRTSceneWorld {
    ...
    SetVisibleRangeMin(visibleRangeMin: TSRVector3): void;
    SetVisibleRangeMax(visibleRangeMax: TSRVector3): void;
    SetUseClipPlanes(useClipPlanes: boolean): void;
    delete(): void;
}
/**
...
export declare class SCRTPoint3DSceneEntity extends SCRTSceneEntity {
    ...
    UpdateMeshesVec(xValues: SCRTDoubleVector, yValues: SCRTDoubleVector, zValues: SCRTDoubleVector, colors: SCRTUintVector, scaleFactors: SCRTFloatVector, params: SCRTPoint3DSceneEntityParams): void;
    delete(): void;
}
...
export declare class SCRTColumnsSceneEntity extends SCRTSceneEntity {
    ...
    UpdateMeshesVec(xValues: SCRTDoubleVector, yValues: SCRTDoubleVector, zValues: SCRTDoubleVector, scaleFactors: SCRTFloatVector, colors: SCRTUintVector, params: SCRTColumnsSceneEntityParams): void;
    delete(): void;
}
...
export declare class SCRTPointLine3DSceneEntity extends SCRTSceneEntity {
    ...
    UpdateMeshesVec(xValues: SCRTDoubleVector, yValues: SCRTDoubleVector, zValues: SCRTDoubleVector, pointColors: SCRTUintVector, lineColors: SCRTUintVector, scaleFactors: SCRTFloatVector, params: SCRTPointLines3DSceneEntityParams): void;
    delete(): void;
}
...
export declare class SCRTGridMeshEntity extends SCRTSceneEntity {
    ...
    UpdateMeshesVec(heightCoords: SCRTFloatVector, zOffsets: SCRTFloatVector, cellColors: SCRTUintVector, gridWidth: number, gridHeight: number, meshResolution: eSCRTGridMeshResolution): void;
    UpdateHeightCoordinatesVec(heightCoords: SCRTFloatVector, gridWidth: number, gridHeight: number): void;
    delete(): void;
}
...
export declare class eAxisPlaneDrawTitlesMode {
}
export declare class AxisPlaneVisibilityMode {
}
...
export declare class SCRTAxisCubeDescriptor {
    ...
    m_eZxPlaneDrawTitlesMode: eAxisPlaneDrawTitlesMode;
    m_eXyPlaneDrawTitlesMode: eAxisPlaneDrawTitlesMode;
    m_eZyPlaneDrawTitlesMode: eAxisPlaneDrawTitlesMode;
    m_eZxPlaneVisibilityMode: AxisPlaneVisibilityMode;
    m_eXyPlaneVisibilityMode: AxisPlaneVisibilityMode;
    m_eZyPlaneVisibilityMode: AxisPlaneVisibilityMode;
    m_bIsZxPlaneVisible: boolean;
    m_bIsXyPlaneVisible: boolean;
    m_bIsZyPlaneVisible: boolean;
    m_bIsCameraChange: boolean;
    delete(): void;
}
/**
